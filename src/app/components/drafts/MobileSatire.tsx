...
/**
 * DRAFT: Mobile satire design mockup
 * This component is a work in progress and not yet integrated into the main site.
 *
 * Features:
 * - Satirical wireframe style with placeholder brackets
 * - Real before/after AI creative slider with actual images
 * - iPhone-style device frame
 */
export default function MobileSatire() {
    ...
    <div className="min-h-screen bg-neutral-200 p-8 flex justify-center items-start py-12">
      ...
      >
        ...
        >
          {/* Dynamic Island */}
          <div
            className="sticky top-[12px] left-1/2 z-50 mx-auto"
            style={{
              width: "126px",
              height: "37px",
              background: "#000",
          ...
          <div style={{ fontFamily: mono, color: "#000" }}>
            ...
            <div style={{ padding: "0 28px 40px" }}>
              ...
              >
                ...
                <span
                  style={{ fontSize: "11px", textAlign: "center", padding: "0 16px" }}
                >
                  [stock photo of people laughing at salad]
                </span>
              </div>
            ...
            <div style={{ padding: "40px 28px", background: "#000", color: "#fff" }}>
              <div style={{ fontSize: "11px", marginBottom: "12px", opacity: 0.5 }}>
                or skip the bullshit/
              </div>
              <div
                style={{
                  fontSize: "24px",
              ...
              <div style={{ fontSize: "13px", opacity: 0.6, marginBottom: "32px" }}>
                Meta &middot; Creative &middot; Web
              </div>
            ...
            {/* Before/After - Real work with ACTUAL IMAGES */}
            <div style={{ padding: "40px 28px" }}>
              <div style={{ fontSize: "11px", marginBottom: "16px" }}>AI Creative/</div>

              {/* Actual Before/After Slider with Real Images */}
              <div
                style={{
                  position: "relative",
                  width: "100%",
              ...
              >
                ...
                >
                  <div style={{ position: "relative", width: "334px", height: "100%" }}>
                    <Image
                      src="/images/apparel-after.png"
            ...
            <div style={{ padding: "40px 28px" }}>
              ...
              >
                ...
                <div style={{ padding: "16px" }}>
                  ...
                  >
                    ...
                    >
                      <Image
                        src="/images/homewares-after.png"
                        alt="AI generated"
                        fill
                        style={{ objectFit: "cover" }}
                      />
              ...
              <div style={{ fontSize: "11px", marginTop: "16px", opacity: 0.5 }}>
                your site &rarr; designed, built, shipped
              </div>
            </div>
            ...
            {/* Marketing Section */}
            <div style={{ padding: "40px 28px", background: "#000", color: "#fff" }}>
              <div style={{ fontSize: "11px", marginBottom: "16px", opacity: 0.5 }}>
                Marketing/
              </div>
              <div style={{ fontSize: "20px", fontWeight: "700", marginBottom: "24px" }}>
                [vanity metrics]
            ...
            <div style={{ padding: "40px 28px" }}>
              ...
              <div style={{ marginBottom: "28px" }}>
                ...
                <div style={{ fontSize: "13px", opacity: 0.6, lineHeight: 1.5 }}>
                  We run BHM with our own money. Every strategy we recommend is one
              ...
              <div style={{ marginBottom: "28px" }}>
                ...
                <div style={{ fontSize: "13px", opacity: 0.6, lineHeight: 1.5 }}>
                  No account managers. No junior staff learning on your dime. Direct
                  access to the people actually building.
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ fontSize: "13px", opacity: 0.6, lineHeight: 1.5 }}>
                  We&apos;re not trying to scale an agency. If we can&apos;t move the
                  needle, we&apos;ll say so upfront.
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                <span>[</span>
                <span style={{ opacity: cursorVisible ? 1 : 0, fontWeight: "300" }}>
                  |
                </span>
                <span>]</span>
              </div>
